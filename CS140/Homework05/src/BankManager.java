...
public class BankManager {
	...
	public static final String MENU = "Type \"add\" to add an account to the bank\n" + 
			...
			"Type \"save\" to to save account information\n" + 
			"Type \"load\" to to save account information\n" + 
	...
	public static void main(String[] args) {
		...
		while(!userSelection.equalsIgnoreCase(QUIT)) {
			...
			else if(userSelection.equalsIgnoreCase(SAVE)) {
				System.out.println("Save selected...");
				BankMethods.save(accountName, accountBalance, 
						currentAccountCount);
			}
			else if(userSelection.equalsIgnoreCase(LOAD)) {
				System.out.println("Load selected...");
				BankMethods.load(accountName, accountBalance, 
						currentAccountCount);
			}
